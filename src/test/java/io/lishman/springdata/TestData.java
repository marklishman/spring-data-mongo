...
public class TestData {
    ...
    public static void cities() {
        ...
        cities.insert(cityFromJson("world", 8, "{ '_id' : '1', '_class' : 'city', 'name' : 'Tokyo', 'attractions' : [ 'Mount Fuji', 'Tokyo Skytree', 'Disneyland' ] }"));
        cities.insert(cityFromJson("world", 5, "{ '_id' : '2', '_class' : 'city', 'name' : 'Munich', 'attractions' : [ 'English Garden', 'BMW Museum' ] }"));
        cities.insert(cityFromJson("world", 5, "{ '_id' : '3', '_class' : 'city', 'name' : 'Berlin', 'attractions' : [ 'Brandenburg Gate', 'Berlin TV Tower', 'Reichstag building' ] }"));
        cities.insert(cityFromJson("world", 11, "{ '_id' : '4', '_class' : 'city', 'name' : 'New York', 'attractions' : [ 'Empire State Building', 'Statue of Liberty', 'Central Park', 'Times Square', 'Bronx Zoo' ] }"));
        cities.insert(cityFromJson("world", 11, "{ '_id' : '5', '_class' : 'city', 'name' : 'Boston', 'attractions' : [ 'Freedom Trail', 'Fenway Park', 'Beacon Hill' ] }"));
    }
    ...
    private static DBObject cityFromJson(String db, long countryId, String json) {
